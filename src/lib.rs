...
#[derive(Debug)]
pub struct ScalaServiceProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ScalaServiceProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ScalaService processing");
    
    let mut processor = ScalaServiceProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ScalaServiceProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ScalaServiceProcessor::new(false);
